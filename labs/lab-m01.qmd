...
2.  Add a column `inc` that indicates whether there was a Democratic incumbent at the time of each election. For the 2014 election in every State/District, `inc` will be `NA`, because there is no election data before 2014. But for the 2016 election in each State/District, `inc` will indicate whether a Democrat won that State/District in 2014.
...
![exercise 1 output](../imgs/m01-lab01-ex01.png)

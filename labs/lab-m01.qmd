...
rec <- recipe(prop_D_2018 ~ ., train) %>% 
  ...
  step_mutate(prior_uncontested = if_else(prop_D_2016 == 0, 1, 0)) 

lin_wflow2 <- workflow() %>% 
  add_recipe(rec) %>% 
  add_model(linear_spec)

lin_fit2 <- fit(lin_wflow2, data = train)
```
...
-   `*_D_2018` --\> `_D_2016`
-   `*_D_2016` --\> `_D_2014`
-   `incumbent_D_2020` --\> `incumbent_D_2018`
:::

```{r}
test2020 <-  test %>% 
  mutate(
    prop_D_2014 = prop_D_2016,
    prop_D_2016 = prop_D_2018,
    incumbent_D_2016 = incumbent_D_2018,
    incumbent_D_2018 = incumbent_D_2020
  )
```

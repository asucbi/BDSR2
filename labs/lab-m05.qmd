...
Below, make three plots: 
- 1. `ACCELEROMETER_X_mean` by `ACCELEROMETER_Y_mean` 
- 2. `GRAVITY_X_mean` by `GRAVITY_Y_mean` 
- 3. `GYROSCOPE_X_mean` by `GYROSCOPE_Y_mean`
:::

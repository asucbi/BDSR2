...
Begin by building histograms for `Age`, `AnnualIncome` and `SpendingScore`, and a plot showing the breakdown of `Gender` (bonus points for plotting `Gender` as a pie chart rather than histogram)
:::

...
- One solution is to fit large tree, and then to **prune** the resulting decision tree according to a *complexity penalty* (akin to regularization or penalized regression)
- **Ensemble methods** are a more powerful approach
  - Bagging
  - Boosting
  - Random Forests

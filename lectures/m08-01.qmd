...
:::: {.columns}
::: {.column width="50%"}
- Sometimes non-scientists just wants a prediction for some application:
...
:::
::: {.column width="50%"}
- But even in these cases, we often need interpretability
...
data --> black box --> predictions (make a mermaid diagram)

...
## 2-way Partial Dependency Plots

Partial dependency plots can also be made in two dimensions, to plot the relationship between two variables and the outcome.
